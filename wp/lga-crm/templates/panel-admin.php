    ...
    <div class="lga-card overflow-hidden">
        <div class="overflow-x-auto">
            <table class="lga-table">
                ...
                <tbody>
                <?php if ( empty( $items ) ): ?>
                    <tr><td colspan="7" class="p-10 text-center text-zinc-400">No hay solicitudes pendientes.</td></tr>
    ...
    <div class="lga-card overflow-hidden">
        <div class="overflow-x-auto">
            <table class="lga-table">
                ...
                <tbody>
                <?php if ( empty( $items ) ): ?>
                    <tr><td colspan="7" class="p-10 text-center text-zinc-400">No hay leads todavía.</td></tr>
                <?php else: foreach ( $items as $p ):
                    $first = get_field( 'first_name', $p->ID );
                    $last  = get_field( 'last_name', $p->ID );
                    $dni   = get_field( 'dni', $p->ID );
    ...
    <div class="lga-card overflow-hidden">
        <div class="overflow-x-auto">
            <table class="lga-table">
                ...
                <tbody>
                <?php if ( empty( $items ) ): ?>
                    <tr><td colspan="6" class="p-10 text-center text-zinc-400">No hay clientes todavía.</td></tr>
                <?php else: foreach ( $items as $p ):
                    $first = get_field( 'first_name', $p->ID );
                    $last  = get_field( 'last_name', $p->ID );
                    $dni   = get_field( 'dni', $p->ID );
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-xs text-zinc-600"><?php echo esc_html( lga_crm_label( 'origen', $origen ) ); ?></td>
                        <td class="text-sm">
                            <?php if ( $cob_user ): ?>
    ...
    <div class="lga-card overflow-hidden">
        <div class="overflow-x-auto">
            <table class="lga-table">
                ...
                <tbody>
                <?php if ( empty( $items ) ): ?>
                    <tr><td colspan="6" class="p-10 text-center text-zinc-400">No hay créditos todavía.</td></tr>
                <?php else: foreach ( $items as $p ):
